...
```bash
pytest tests/ -v                    # Fast suite: 1,429 passing (1,688 collected with slow/integration/functional)
...
| Target | Description |
|--------|-------------|
| `make test` | Fast unit tests (1,429 passing, no external deps) |
| `make test-slow` | Full suite including matrix + perf + generated project tests (1,688 collected) |
