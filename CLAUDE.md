...
```bash
pytest tests/ -v                    # Fast suite: 1,454 passing (full CI suite with connectors extra: 1,866 passing / 1,881 collected)
...
| Target | Description |
|--------|-------------|
| `make test` | Fast unit tests (1,454 passing, no external deps) |
