...
```bash
pytest tests/ -v                    # Fast suite: 1,437 passing (1,697 collected with slow/integration/functional)
...
| `make test-slow` | Full suite including matrix + perf + generated project tests (1,697 collected) |
